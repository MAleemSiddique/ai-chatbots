...
@app.route('/chat2', methods=['OPTIONS', 'POST'])
def chat2():
    if request.method == 'OPTIONS':
        response = make_response()
        response.headers.add("Access-Control-Allow-Origin", "*")
    ...
    if request.method == 'POST':
        ...
        # System prompt to set chatbot behavior
        system_prompt = "You are roleplaying as a kind old lady for this chat who is always very warm and understanding and offers good advice."
...
@app.route('/chat3', methods=['OPTIONS', 'POST'])
def chat3():
    if request.method == 'OPTIONS':
        response = make_response()
        response.headers.add("Access-Control-Allow-Origin", "*")
    ...
    if request.method == 'POST':
        ...
        # System prompt to set chatbot behavior
        system_prompt = "You are roleplaying as a carefree young man, exploring the beauty this world has to offer and advising others to take a breath and appreciate the small things in life."
